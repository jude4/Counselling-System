...
<div class="form-three widget-shadow">
    <h1 class="text-center">Create Counsellor
    </h1>
<div data-example-id="form-validation-states">
    <form action="{{ route('manage.store')}}" method="POST">
        ...
        <div class="form-group has-primary">
            ...
            <input type="text" name="counsellor_id" placeholder="Counsellor ID" class="form-control{{ $errors->has('counsellor_id') ? ' is-invalid' : '' }}" id="inputSuccess1" aria-describedby="helpBlock2"  value="{{ old('counsellor_id') }}" required autofocus>
