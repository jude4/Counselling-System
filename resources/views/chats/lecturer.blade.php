...
<?php $id = 1; ?>
                                      ...
                                      <thead>
                                          <tr role="row">
                                              <th class="sorting_asc" tabindex="0" aria-controls="dash-table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Product: activate to sort column descending" style="width: 107px;">
                                                ...
                                                {{--  <th class="sorting" tabindex="0" aria-controls="dash-table" rowspan="1" colspan="1" aria-label="Expired Date: activate to sort column ascending" style="width: 157px;">In-Stock</th>
                                ...
                                <tr>
                                                ...
                                                <td>{{$msg->body}}</td>
                                                <td><a href="{{url('chats/profile', $msg->sender_id)}}" class="btn btn-info btn-sm">View profile</a></td>
                                                <td>
